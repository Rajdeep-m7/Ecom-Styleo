...
function Hero() {
  return (
    <div className='relative'>
        <img src={heroImg} className='w-full  h-120 md:h-140 object-cover'/> 
        <div className='absolute inset-0 bg-black/40 flex gap-3 p-3 md:gap-5 flex-col justify-center items-center'>
            ...
            <Link className='bg-white  p-2 rounded-lg px-4'>
            Shop Now
            </Link>
        </div>
    </div>
