...
function AdminSidebar() {
  ...
  return (
    <div className='p-6'>
        <div className="mb-6">
            <Link className='text-2xl font-medium' to="/admin">Styleo</Link>
        </div>
        ...
        <div className='mt-6'>
            <button onClick={handleLogout} className='w-full bg-red-500 hover:bg-red-600 text-white rounded py-2 px-4 flex items-center justify-center space-x-2'>
                <FaSignOutAlt/>
                <span>Logout</span>
            </button>
        </div>
